          ...
          FocusedMenuHolder(
            ...
            menuItems: <FocusedMenuItem>[
              FocusedMenuItem(
                  title: Text("FaceBook"),
                  onPressed: () {},
                  trailingIcon: Icon(Icons.zoom_in_sharp)),
              FocusedMenuItem(
                  title: Text("WhatsApp"),
                  onPressed: () {},
                  trailingIcon: Icon(Icons.zoom_in_sharp)),
                ...
                children: <Widget>[
                  new InkWell(
                    child: new Card(
                      child: new Container(
                        padding: new EdgeInsets.only(
                            top: 35.0, left: 30.0, right: 45.0, bottom: 35.0),
                        child: Center(
                          child: new Column(
                            children: <Widget>[
                              new Icon(Icons.local_hospital_outlined,
                      ...
                      return showDialog(
                          ...
                          builder: (BuildContext context) {
                            return new AlertDialog(
                              ...
                              content: new Text(
                                "cliquez une seule fois sur le bloc de pharmacie"
                      ...
                      return showDialog(
                          ...
                          builder: (BuildContext context) {
                            return new AlertDialog(
                              ...
                              content: new Text(
                                "cliquez une seule fois sur le bloc de Hopital"
                      ...
                      return showDialog(
                          ...
                          builder: (BuildContext context) {
                            return new AlertDialog(
                              ...
                              content: new Text(
                                "cliquez une seule fois sur le bloc de Restaurant"
                      ...
                      return showDialog(
                          ...
                          builder: (BuildContext context) {
                            return new AlertDialog(
                              ...
                              content: new Text(
                                "cliquez une seule fois sur le bloc de Supermarché"
                      ...
                      return showDialog(
                          ...
                          builder: (BuildContext context) {
                            return new AlertDialog(
                              ...
                              content: new Text(
                                "cliquez une seule fois sur le bloc de Transport"
                      ...
                      return showDialog(
                          ...
                          builder: (BuildContext context) {
                            return new AlertDialog(
                              ...
                              content: new Text(
                                "cliquez une seule fois sur le bloc de Hotel"
